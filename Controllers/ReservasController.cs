    ...
    public class ReservasController : ControllerBase
    {
        ...
        public async Task<ActionResult<Reserva>> PostReserva(Reserva reserva)
        {
          if (_context.Reservas == null)
          {
            ...
            {
                if (ReservaExists(reserva.IdOferta))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetReserva", new { id = reserva.IdOferta }, reserva);
        }
        ...
        {
            return (_context.Reservas?.Any(e => e.IdOferta == id)).GetValueOrDefault();
        }
    }
}
